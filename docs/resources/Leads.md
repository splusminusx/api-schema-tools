...
### Описание метода
Возвращает список лидов в контексте маршрутизации.<br/>Метод работает точно также, как и метод Leads.list, но предоставляет доступ только к лидам, адресованным текущему сотруднику.<br/>Массив объектов типа «Lead».<br/><br/>
### Поля
...
### Описание метода
Возвращает список лидов.<br/>Массив объектов типа «Lead».<br/><br/>
### Поля
