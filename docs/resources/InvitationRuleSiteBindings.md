...
### Описание метода
Добавляет новую связь сценария вовлечения и сайта.<br/>Возможно существование только одной связи конкретного сайта и конкретного сценария вовлечения.<br/>Объект типа «InvitationRuleSiteBinding».<br/><br/>
### Поля
...
### Описание метода
Возвращает данные указанной связи сценария вовлечения и сайта.<br/>Объект типа «InvitationRuleSiteBinding».<br/><br/>
### Поля
...
### Описание метода
Возвращает список связей сценариев вовлечения и сайтов.<br/>Массив объектов типа «InvitationRuleSiteBinding».<br/><br/>
### Поля
...
### Описание метода
Изменяет указанную связь сценария вовлечения и сайта.<br/>Возможно существование только одной связи конкретного сайта и конкретного сценария вовлечения.<br/>Метод ничего не возвращает.<br/><br/>
### Поля
...
### Описание метода
Удаляет указанную связь сценария вовлечения и сайта.<br/>Метод ничего не возвращает.<br/><br/>
### Поля
