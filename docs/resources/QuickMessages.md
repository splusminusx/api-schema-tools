...
### Описание метода
Добавляет новое быстрое сообщение.<br/><br/>
### Поля
...
### Описание метода
Возвращает данные указанного быстрого сообщения.<br/><br/>
### Поля
...
### Описание метода
Возвращает список быстрых сообщений.<br/><br/>
### Поля
...
### Описание метода
Обновляет быстрое сообщение.<br/><br/>
### Поля
...
### Описание метода
Удаляет указанное быстрое сообщение.<br/><br/>
### Поля
