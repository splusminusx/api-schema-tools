...
### Описание метода
Создает новый отдел.<br/>ВНИМАНИЕ!<br/>При создании отдела с привязкой к сайту, в котором еще нет отделов, все прямые связи такого сайта с сотрудниками удаляются.<br/>Новый отдел автоматически добавляется в поле managed_departments всем сотрудникам с ролью, имеющей is_full_by_default = true.<br/>Объект типа «Department».<br/><br/>
### Поля
...
### Описание метода
Возвращает данные указанного отдела.<br/>Объект типа «Department».<br/><br/>
### Поля
...
### Описание метода
Возвращает список отделов.<br/>Массив объектов типа «Department».<br/><br/>
### Поля
...
### Описание метода
Изменяет данные указанного отдела.<br/>ВНИМАНИЕ!<br/>При опустошении списка сотрудников отдел автоматически удаляется.<br/>Метод ничего не возвращает.<br/><br/>
### Поля
