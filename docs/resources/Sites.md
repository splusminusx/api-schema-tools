...
|*is_active*|False|[boolean](/types/boolean)|Включение/выключение использования внешнего почтового ящика.<br/>Если функция выключена, то письма будут отправляться через сервера LiveTex c системными значениями отправителя, темы и подписи.<br/>|
|*signature*|False|[string](/types/string)|Подпись.<br/>Максимум 60 символов.<br/>|
|*mailbox_id*|False|[numeric](/types/numeric)|ID почтового ящика.<br/>Если указано null, то для отправки почты будут использоваться сервера LiveTex.<br/>|
|*id*|True|[numeric](/types/numeric)|ID сайта.<br/>|
|*subject*|False|[string](/types/string)|Тема письма.<br/>Максимум 60 символов.<br/>|
...
| Имя поля | Необходимость | Тип данных | Комментарий |
|---|---|---|---|
|*q*|False|[string](/types/string)|Критерий поиска.<br/>Доступные поля:<br/>ids – idlist, список ID сайтов.<br/>url – string, подстрока в адресе сайта.<br/>is_managed – boolean, признак своего сайта.<br/>|
|*fields*|False|[string](/types/string)|Список через запятую возвращаемых полей.<br/>|
|*limit*|False|[numeric](/types/numeric)|По умолчанию – 50.<br/>|
|*sort*|False|[string](/types/string)|Сортировка результатов.<br/>Возможные значения:<br/>url:a – по умолчанию;<br/>updated_at:a, updated_at:d;<br/>|
...
| Имя поля | Необходимость | Тип данных | Комментарий |
|---|---|---|---|
|*offset_value*|False|[numeric](/types/numeric)|Значение отступа.<br/>Целое число в диапазоне:<br/>от 0 до 100 для offset_type = percent;<br/>от 0 до 2000 для offset_type = pixel.<br/>|
...
|*photo_size*|False|[string](/types/string)|Размер фотографии сотрудника.<br/>Возможные значения:<br/>small – маленькая, 60x70 пикселей;<br/>large – большая, 100x116 пикселей.<br/>|
...
|*is_hidden_offline*|False|[boolean](/types/boolean)|Скрывать ярлык, если сотрудники офлайн.<br/>|
|*offset_type*|False|[string](/types/string)|Тип отступа.<br/>Возможные значения:<br/>pixel – в пикселах;<br/>percent – в процентах.<br/>|
|*banner_type*|False|[string](/types/string)|Тип баннера.<br/>Возможные значения:<br/>none – без баннера;<br/>default – стандартный баннер;<br/>custom – загружаемый баннер.<br/>|
...
|*background_typе*|False|[string](/types/string)|Тип фона.<br/>Возможные значения:<br/>none – без фона;<br/>default – стандартный фон;<br/>custom – загружаемый фон.<br/>|
|*color_type*|False|[string](/types/string)|Тип указания цветовой схемы.<br/>Возможные значения:<br/>preset – стандартная схема;<br/>custom – явное указание цветов.<br/>|
|*size*|False|[string](/types/string)|Размер ярлыка.<br/>Возможные значения:<br/>small – маленький, 24x106 пикселей;<br/>large – большой, 40x178 пикселей (по умолчанию).<br/>|
...
### Результат
[ChatWelcomeSettings](/types/ChatWelcomeSettings)
### Доступы к методу
...
| Имя поля | Необходимость | Тип данных | Комментарий |
|---|---|---|---|
|*is_complaint*|False|[boolean](/types/boolean)|Включение/выключение жалоб.<br/>|
|*is_callback*|False|[boolean](/types/boolean)|Включение/выключение функциональности «Перезвоните мне».<br/>|
|*ids*|True|[idlist](/types/idlist)|Список, через запятую, ID сайтов.<br/>|
|*complaint_email*|False|[string](/types/string)|Адрес электронной почты, на который будут отправляться нотификации о поступлении новой жалобы.<br/>|
|*is_vote*|False|[boolean](/types/boolean)|Включение/выключение функциональности оценки чата посетителем.<br/>|
|*is_mobile*|False|[boolean](/types/boolean)|Включение/выключение мобильного вида виджета.<br/>|
...
### Результат
[OfflineFormSettings](/types/OfflineFormSettings)
### Доступы к методу
...
| Имя поля | Необходимость | Тип данных | Комментарий |
|---|---|---|---|
|*prechats_chat*|False|Array.<[Prechat](/types/Prechat)>|Массив объектов типа Prechat.<br/>Максимум 2 элемента.<br/>|
|*is_lead*|False|[boolean](/types/boolean)|Включение/выключение функциональности генератора лидов.<br/>По умолчанию – true.<br/>|
|*is_call_label*|False|[boolean](/types/boolean)|Включение/выключение ярлыка звонков.<br/>DEPRECATED!<br/>|
|*employee_ids*|False|[idlist](/types/idlist)|Список ID сотрудников через запятую.<br/>|
|*url*|True|[string](/types/string)|Адрес сайта.<br/>Например: www.mysite.ru<br/>|
|*is_callback*|False|[boolean](/types/boolean)|Включение/выключение функциональности «Перезвоните мне».<br/>По умолчанию – true.<br/>|
|*is_complaint*|False|[boolean](/types/boolean)|Включение/выключение жалоб.<br/>По умолчанию – false.<br/>|
|*is_hidden_offline*|False|[boolean](/types/boolean)|Скрывать ярлык, если сотрудники офлайн.<br/>По умолчанию – false.<br/>|
|*complaint_email*|False|[email](/types/email)|Адрес электронной почты, на который будут отправляться нотификации о поступлении новой жалобы.<br/>Обязателен, если указано is_complaint = true.<br/>|
|*is_vote*|False|[boolean](/types/boolean)|Включение/выключение функциональности оценки чата посетителем.<br/>По умолчанию – true.<br/>|
|*is_mobile*|False|[boolean](/types/boolean)|Включение/выключение мобильного вида виджета.<br/>|
|*is_site_prechats*|False|[boolean](/types/boolean)|Признак использования пречат-полей сайта.<br/>Если false, то будут использоваться пречаты из связей отделов с сайтом.<br/>По умолчанию – true.<br/>|
|*callback_url*|False|[string](/types/string)|Настройка Callback URL.<br/>|
|*hold_rule_id*|False|[numeric](/types/numeric)|ID сценария удержания.<br/>|
...
### Результат
[ChatFormSettings](/types/ChatFormSettings)
### Доступы к методу
...
| Имя поля | Необходимость | Тип данных | Комментарий |
|---|---|---|---|
|*offline_contacts*|False|[string](/types/string)|Запрашиваемые контактные данные в офлайн-режиме.<br/>Возможные значения:<br/>email -  запрашивается только email;<br/>phone – запрашивается только телефон;<br/>email_or_phone – запрашивается телефон или email;<br/>email_and_phone – запрашивается телефон и email.<br/>|
|*offline_confirmation*|False|[string](/types/string)|Текст подтверждения в режиме офлайн. Отображается после успешной отправки запроса.<br/>Максимум 180 символов.<br/>|
...
|*offline_welcome*|False|[string](/types/string)|Текст приветствия в режиме офлайн.<br/>Максимум 180 символов.<br/>|
|*id*|True|[numeric](/types/numeric)|ID сайта.<br/>|
|*online_welcome*|False|[string](/types/string)|Текст приветствия в режиме онлайн.<br/>Максимум 180 символов.<br/>|
...
| Имя поля | Необходимость | Тип данных | Комментарий |
|---|---|---|---|
|*is_visible*|False|[boolean](/types/boolean)|Показывать ярлык.<br/>|
|*offset_value*|False|[numeric](/types/numeric)|Значение отступа.<br/>Целое число в диапазоне:<br/>от 0 до 100 для offset_type = percent;<br/>от 0 до 2000 для offset_type = pixel.<br/>|
...
|*offset_type*|False|[string](/types/string)|Тип отступа.<br/>Возможные значения:<br/>pixel – в пикселах;<br/>percent – в процентах.<br/>|
|*position*|False|[string](/types/string)|Положение ярлыка.<br/>Возможные значения:<br/>top – сверху;<br/>right – справа;<br/>bottom – снизу;<br/>left – слева.<br/>|
|*size*|False|[string](/types/string)|Размер ярлыка.<br/>Возможные значения:<br/>small – маленький, 23x118 пикселей;<br/>large – большой, 38x174 пикселей.<br/>|
|*id*|True|[numeric](/types/numeric)|ID сайта.<br/>|
...
| Имя поля | Необходимость | Тип данных | Комментарий |
|---|---|---|---|
|*is_department*|False|[boolean](/types/boolean)|Включение/выключение выбора отдела для офлайн режима.<br/>При создании сайта устанавливается в false.<br/>|
|*offset_value*|False|[numeric](/types/numeric)|Значение отступа в процентах.<br/>Число в диапазоне от 0 до 100. Может быть дробным.<br/>|
|*label_text_offline*|False|[string](/types/string)|Текст на ярлыке, когда доступных операторов нет.<br/>|
|*color*|False|[string](/types/string)|Цветовая схема.<br/>Возможные значения:<br/>green – зеленая;<br/>orange – оранжевая;<br/>blue – синяя;<br/>red – красная;<br/>purple – фиолетовая;<br/>gray – серая;<br/>rose – розовая;<br/>black – черная;<br/>yellow – желтая;<br/>white – белая.<br/>Поле обязательно для color_type = preset.<br/>|
|*color_type*|False|[string](/types/string)|Тип указания цветовой схемы.<br/>Возможные значения:<br/>preset – стандартная схема;<br/>custom – явное указание цветов.<br/>|
|*label_text_online*|False|[string](/types/string)|Текст на ярлыке, когда есть доступные операторы.<br/>|
|*color_custom*|False|[color](/types/color)|Цвет.<br/>Поле обязательно для color_type = custom.<br/>|
|*is_embedded*|False|[boolean](/types/boolean)|Включение/выключение встроенного окна чата.<br/>Если выключено, то будет использоваться внешнее окно чата.<br/>|
...
|*banner_type*|False|[string](/types/string)|Тип баннера.<br/>Возможные значения:<br/>none – без баннера;<br/>default – стандартный баннер;<br/>custom – загружаемый баннер.<br/>Актуально только для внешнего окна.<br/>|
...
|*position*|False|[string](/types/string)|Положение ярлыка.<br/>Возможные значения:<br/>right – справа;<br/>bottom – снизу;<br/>left – слева.<br/>|
|*id*|True|[numeric](/types/numeric)|ID сайта.<br/>|
|*color_text*|False|[string](/types/string)|Цвет текста.<br/>Возможные значения:<br/>light – светлый;<br/>dark – темный;<br/>auto – значение выбирается автоматически.<br/>|
...
| Имя поля | Необходимость | Тип данных | Комментарий |
|---|---|---|---|
|*confirmation*|False|[string](/types/string)|Текст подтверждения по умолчанию.<br/>Максимум 180 символов.<br/>|
...
|*welcome*|False|[string](/types/string)|Текст приветствия по умолчанию.<br/>Максимум 180 символов.<br/>|
|*banner_custom*|False|[file](/types/file)|Загруженная баннер для banner_type = custom.<br/>Изображение в формате JPEG, GIF или PNG с шириной от 1 до 448 px и высотой 82 px.<br/>Поле обязательно для banner_type = custom.<br/>|
|*background_custom*|False|[file](/types/file)|Загруженный фон для background_type = custom.<br/>Изображение в формате JPEG, GIF или PNG с размерами 448x605px.<br/>Поле обязательно для background_type = custom.<br/>|
|*banner_type*|False|[string](/types/string)|Тип баннера.<br/>Возможные значения:<br/>none – без баннера;<br/>default – стандартный баннер;<br/>custom – загружаемый баннер.<br/>|
|*banner_link*|False|[string](/types/string)|Ссылка с баннера.<br/>Поле обязательно для banner_type = custom.<br/>|
|*confirmation_mobile*|False|[string](/types/string)|Текст подтверждения по умолчанию, который отобразится в мобильных браузерах.<br/>Максимум 180 символов.<br/>ВНИМАНИЕ! В данный момент это поле не используется.<br/>|
|*background_typе*|False|[string](/types/string)|Тип фона.<br/>Возможные значения:<br/>none – без фона;<br/>default – стандартный фон;<br/>custom – загружаемый фон.<br/>|
|*id*|True|[numeric](/types/numeric)|ID сайта.<br/>|
|*welcome_mobile*|False|[string](/types/string)|Текст приветствия по умолчанию, который отобразится в мобильных браузерах.<br/>Максимум 180 символов.<br/>ВНИМАНИЕ! В данный момент это поле не используется.<br/>|
...
| Имя поля | Необходимость | Тип данных | Комментарий |
|---|---|---|---|
|*text*|False|[string](/types/string)|Текст приветствия.<br/>Максимум 180 символов.<br/>|
|*id*|True|[numeric](/types/numeric)|ID сайта.<br/>|
...
|---|---|---|---|
|*prechats_chat*|False|Array.<[Prechat](/types/Prechat)>|Массив объектов типа Prechat.<br/>Максимум 2 элемента.<br/>|
|*is_lead*|False|[boolean](/types/boolean)|Включение/выключение функциональности генератора лидов.<br/>|
|*is_call_label*|False|[boolean](/types/boolean)|Включение/выключение ярлыка звонков.<br/>DEPRECATED!<br/>|
|*employee_ids*|False|[idlist](/types/idlist)|Список ID сотрудников через запятую.<br/>Если с сайтом связан, хотя бы один отдел, то этот параметр игнорируется.<br/>|
|*url*|False|[string](/types/string)|Адрес сайта.<br/>|
|*is_callback*|False|[boolean](/types/boolean)|Включение/выключение функциональности «Перезвоните мне».<br/>|
|*is_complaint*|False|[boolean](/types/boolean)|Включение/выключение жалоб.<br/>|
|*is_hidden_offline*|False|[boolean](/types/boolean)|Скрывать ярлык, если сотрудники офлайн.<br/>|
...
|*is_vote*|False|[boolean](/types/boolean)|Включение/выключение функциональности оценки чата посетителем.<br/>|
|*is_mobile*|False|[boolean](/types/boolean)|Включение/выключение мобильного вида виджета.<br/>|
|*is_site_prechats*|False|[boolean](/types/boolean)|Признак использования пречат-полей сайта.<br/>Если false, тоe. то будут использоваться пречаты из связей отделов с сайтом.<br/>|
|*callback_url*|False|[string](/types/string)|Настройка Callback URL.<br/>|
|*id*|True|[numeric](/types/numeric)|ID редактируемого сайта.<br/>|
|*hold_rule_id*|False|[numeric](/types/numeric)|ID сценария удержания.<br/>|
...
| Имя поля | Необходимость | Тип данных | Комментарий |
|---|---|---|---|
|*is_department*|False|[boolean](/types/boolean)|Включение/выключение выбора отдела в форме лида.<br/>|
...
|*color_main*|False|[color](/types/color)|Основной цвет.<br/>Поле обязательно для color_type = custom.<br/>|
|*id*|True|[numeric](/types/numeric)|ID сайта.<br/>|
|*label*|False|[string](/types/string)|Надпись на ярлыке.<br/>Возможные значения:<br/>question – «Задать вопрос»;<br/>action – «Внимание! Акция»;<br/>gift – «Внимание! Подарок»;<br/>help – «Обратитесь за помощью»;<br/>best – «Посоветуем лучшее»;<br/>waiting – «Ждем Ваших вопросов»;<br/>choice – «Поможем с выбором»;<br/>consulting – «Получить консультацию».<br/>|
|*banner_type*|False|[string](/types/string)|Тип баннера.<br/>Возможные значения:<br/>none – без баннера;<br/>default – стандартный баннер;<br/>custom – загружаемый баннер.<br/>|
|*color_background*|False|[color](/types/color)|Цвет фона.<br/>Поле обязательно для color_type = custom.<br/>|
...
|*welcome_mobile*|False|[string](/types/string)|Текст приветствия по умолчанию, который отобразится в мобильных браузерах.<br/>Максимум 180 символов.<br/>ВНИМАНИЕ! В данный момент это поле не используется.<br/>|
|*lead_type*|False|[string](/types/string)|Запрашиваемые контактные данные.<br/>email -  запрашивается только email;<br/>phone – запрашивается только телефон;<br/>email_or_phone – запрашивается телефон или email;<br/>email_and_phone – запрашивается телефон и email.<br/>|
|*photo_type*|False|[string](/types/string)|Тип картинки приветствия.<br/>Возможные значения:<br/>none – без картинки;<br/>default – стандартное фото;<br/>custom – загруженное фото.<br/>|
|*confirmation_mobile*|False|[string](/types/string)|Текст подтверждения по умолчанию, который отобразится в мобильных браузерах.<br/>Максимум 180 символов.<br/>ВНИМАНИЕ! В данный момент это поле не используется.<br/>|
|*required_fields*|False|[string](/types/string)|Обязательность полей при lead_type = email_and_phone.<br/>email – e-mail;<br/>phone – телефон;<br/>email_and_phone – email и телефон.<br/>Поле обязательно при lead_type = email_and_phone.<br/>|
|*color_text*|False|[color](/types/color)|Цвет текста.<br/>Поле обязательно для color_type = custom.<br/>|
...
### Результат
[LeadFormSettings](/types/LeadFormSettings)
### Доступы к методу
...
| Имя поля | Необходимость | Тип данных | Комментарий |
|---|---|---|---|
|*interval_end*|False|[number](/types/number)|Конец интервала. Количество секунд от 00:00.<br/>|
|*interval_begin*|False|[number](/types/number)|Начало интервала. Количество секунд от 00:00.<br/>|
|*is_active*|False|[boolean](/types/boolean)|Включение/выключение мобильного вида виджета.<br/>|
|*ids*|True|[idlist](/types/idlist)|Список, через запятую, ID сайтов.<br/>|
|*days*|False|Array.<[numeric](/types/numeric)>|Массив дней недели, в которые необходимо показывать приглашение к заказу обратного звонка.<br/>Понедельник – 0, вторник - 1 и т.д.<br/>|
...
|*interval_end*|False|[number](/types/number)|Конец интервала. Количество секунд от 00:00.<br/>|
|*interval_begin*|False|[number](/types/number)|Начало интервала. Количество секунд от 00:00.<br/>|
|*is_active*|False|[boolean](/types/boolean)|Включение/выключение функции на сайте.<br/>|
|*id*|True|[numeric](/types/numeric)|ID сайта.<br/>|
|*days*|False|Array.<[numeric](/types/numeric)>|Массив дней недели, в которые необходимо показывать приглашение к заказу обратного звонка.<br/>Понедельник – 0, вторник - 1 и т.д.<br/>|
...
|*greeting_type*|False|[string](/types/string)|Типа мелодии приветствия.<br/>Приветствие проигрывается всем звонящим, перед соединением с оператором. Оператор отвечает только после того как мелодия полностью проиграется.<br/>Возможные значения:<br/>none – без приветствия,<br/>custom – пользовательское приветствие.<br/>|
|*employee_callerid_type*|False|[string](/types/string)|Выбор номера телефона, отображаемого оператору при вызове X-widget.<br/>Возможные значения:<br/>livetex – номер LiveTex (по умолчанию);<br/>visitor – номер, указанный посетителем при заказе звонка.<br/>|
|*background_type*|False|[string](/types/string)|Тип фоновой мелодии.<br/>Фоновая мелодия проигрывается во время ожидания, пока кто-нибудь из операторов не ответит на звонок.<br/>Возможные значения:<br/>none – без приветствия,<br/>default – стандартная фоновая мелодия,<br/>custom – пользовательская фоновая мелодия.<br/>|
...
### Результат
[CallLabelSettings](/types/CallLabelSettings)
### Доступы к методу
