...
### Описание метода
Возвращает статистику по контактным данным.<br/>Метод не имеет параметров.<br/>Объект с полями, описанными в нижеследующей таблице.<br/>Перечень доступных статистических данных<br/><br/>
### Поля
