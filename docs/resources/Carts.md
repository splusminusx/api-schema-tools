...
### Описание метода
Carts.add<br/>Создает новую корзину.<br/>Параметры<br/>Результат<br/>Объект типа «Cart».<br/>Уровень доступа для ролей<br/><br/><br/>
### Поля
...
### Описание метода
Carts.commit<br/>Операция покупки позиций указанной корзины.<br/>Метод создает заказ, выставляет счет на оплату на активного плательщика и удаляет корзину. <br/> Параметры<br/>Результат<br/>Объект типа «Order».<br/>Уровень доступа для ролей<br/><br/>
### Поля
