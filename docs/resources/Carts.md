...
### Описание метода
Создает новую корзину в указанном периоде.<br/>Объект типа «Cart».<br/><br/>
### Поля
...
### Описание метода
Возвращает данные указанной корзины.<br/>Объект типа «Cart».<br/><br/>
### Поля
...
### Описание метода
Возвращает список корзин.<br/>Массив объектов типа «Cart».<br/><br/>
### Поля
...
### Описание метода
Изменяет указанную корзину.<br/>Метод ничего не возвращает. <br/><br/><br/><br/>
### Поля
...
### Описание метода
Создает новую корзину.<br/>Объект типа «Cart».<br/><br/><br/>
### Поля
...
### Описание метода
Операция покупки позиций указанной корзины.<br/>Метод создает заказ, выставляет счет на оплату на активного плательщика и удаляет корзину. <br/> Параметры<br/>Объект типа «Order».<br/><br/>
### Поля
...
### Описание метода
Удаляет указанную корзину.<br/>Метод ничего не возвращает.<br/><br/>
### Поля
