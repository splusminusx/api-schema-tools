...
### Описание метода
Payers.list<br/>Возвращает список плательщиков.<br/>Параметры<br/>Результат<br/>Массив объектов типа «Payer».<br/>Уровень доступа для ролей<br/><br/>
### Поля
...
### Описание метода
Payers.add<br/>Создает нового плательщика.<br/>ВНИМАНИЕ!<br/>Новый плательщик автоматически становится текущим активным плательщиком.<br/>Параметры<br/>Результат<br/>Объект типа «Payer».<br/>Уровень доступа для ролей<br/><br/>
### Поля
...
### Описание метода
Payers.transferBalance<br/>Переносит остатки на счете на активного плательщика.<br/>ПРИМЕЧАНИЯ<br/>Для плательщиков с payer_type, начинающимся с "ru_", перенос осуществляется со всех счетов указанного плательщика на текущий счет активного плательщика.<br/>Для плательщиков с payer_type, начинающимся с "ua_", перенос осуществляется со всех счетов указанного плательщика на подарочный счет активного плательщика.<br/>Параметры<br/>Результат<br/>Метод ничего не возвращает.<br/>Уровень доступа для ролей<br/><br/>
### Поля
...
### Описание метода
Payers.update<br/>Обновляет данные указанного плательщика.<br/>Параметры<br/>Результат<br/>Метод ничего не возвращает.<br/>Уровень доступа для ролей<br/><br/>
### Поля
...
### Описание метода
Payers.show<br/>Возвращает данные указанного плательщика.<br/>Параметры<br/>Результат<br/>Объект типа «Payer».<br/>Уровень доступа для ролей<br/><br/>
### Поля
