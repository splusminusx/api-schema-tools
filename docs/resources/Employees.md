...
### Описание метода
Возвращает данные сотрудника, от учетной записи которого вызывается метод.<br/><br/>
### Поля
...
### Описание метода
Выполняет поиск сотрудника по подстроке в имени или фамилии сотрудника.<br/>Возвращает первые 20 записей, отсортированные сначала по фамилии, а потом по имени.<br/><br/>
### Поля
...
### Описание метода
Возвращает данные указанного сотрудника.<br/><br/>
### Поля
...
### Описание метода
Возвращает список сотрудников.<br/>Пример<br/>{<br/>    "total": 2,<br/>    "results": [<br/>        {<br/>            "id":10000087,<br/>            "first_name":"Иван",<br/>            "last_name":"Петров"<br/>        },<br/>        {<br/>            "id":10000012,<br/>            "first_name":"Ольга",<br/>            "last_name":"Соколова"<br/>        }<br/>    ]<br/>}<br/><br/><br/>
### Поля
...
### Описание метода
Устанавливает новый пароль.<br/>Метод не требует аутентификации!<br/>Уровень доступа для этого метода не определен, поскольку он выполняется в анонимном режиме.<br/>
### Поля
...
### Описание метода
Добавляет промо-код к только что созданному аккаунту.<br/>Этот метод можно вызвать хронологически между Employees.register и Employees.confirm. <br/>Метод не требует аутентификации!<br/>Уровень доступа для этого метода не определен, поскольку он выполняется в анонимном режиме.<br/><br/>
### Поля
...
### Описание метода
Создает учетную запись сотрудника.<br/><br/>
### Поля
...
### Описание метода
Активирует новый аккаунт LiveTex и неявно выполняет аутентификацию пользователя.<br/>Метод не требует аутентификации!<br/>Уровень доступа для этого метода не определен, поскольку он выполняется в анонимном режиме.<br/><br/>
### Поля
...
### Описание метода
Удаляет указанного сотрудника.<br/>ВНИМАНИЕ! При удалении сотрудника, удаляются также отделы, в которых он был единственным сотрудником.<br/><br/>
### Поля
...
### Описание метода
Инициирует процедуру установки нового пароля для указанного адреса электронной почты. Отправляется письмо с уникальной ссылкой на страницу ввода нового пароля.<br/>Метод не требует аутентификации!<br/>Уровень доступа для этого метода не определен, поскольку он выполняется в анонимном режиме.<br/>
### Поля
