...
### Описание метода
Создает новый сценарий удержания.<br/>Объект типа «HoldRule».<br/>Пример вызова<br/>curl "https://api.livetex.ru/v2/holdrules" \<br/>-H "Authorization: Bearer ACCESS_TOKEN" \<br/>	-d "title=Одно сообщение и перевод" \<br/>	-d "hold_messages[0][text]=Оператор скоро вам ответит" \<br/>	-d "hold_messages[0][send_after]=15" \<br/>	-d "is_transfer=true" \<br/>	-d "transfer_after=15"<br/><br/><br/>
### Поля
...
### Описание метода
Возвращает данные указанного сценария удержания.<br/>Объект типа «HoldRule».<br/><br/>
### Поля
...
### Описание метода
Возвращает список сценариев удержания.<br/>Массив объектов типа «HoldRule».<br/><br/>
### Поля
...
### Описание метода
Изменяет указанный сценарий удержания.<br/>Метод ничего не возвращает.<br/><br/>
### Поля
...
### Описание метода
Удаляет указанный сценария удержания.<br/>Метод ничего не возвращает.<br/><br/>
### Поля
