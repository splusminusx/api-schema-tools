...
|fields|False|string|Список возвращаемых полей через запятую.<br/>По умолчанию возвращаются стандартные поля сайта, а также:<br/>online_time;<br/>intervals.<br/>|
