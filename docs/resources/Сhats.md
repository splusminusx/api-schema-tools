...
### Описание метода
Устанавливает признак наличия контактной информации в чате.<br/>Повторный вызов этого метода для одного и того же чата приводит к пополнению массивов найденных контактных данных.<br/>Метод ничего не возвращает.<br/><br/>
### Поля
...
### Описание метода
Возвращает список чатов.<br/>Массив объектов типа «Chat», а также, поле total_conversations.<br/>Перечень дополнительных полей<br/><br/><br/>
### Поля
...
### Описание метода
Возвращает данные указанного чата.<br/>Объект типа «Chat».<br/><br/>
### Поля
