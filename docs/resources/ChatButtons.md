...
### Описание метода
Создает новую кнопку.<br/>Объект типа «ChatButton».<br/><br/>
### Поля
...
### Описание метода
Возвращает данные указанной кнопки.<br/>Объект типа «ChatButton».<br/><br/>
### Поля
...
### Описание метода
Возвращает список кнопок.<br/>Массив объектов типа «ChatButton».<br/><br/>
### Поля
