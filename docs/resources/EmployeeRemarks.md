...
### Описание метода
Создает новую запись в списке оценок сотрудника.<br/>Объект типа «EmployeeRemark».<br/><br/>
### Поля
...
### Описание метода
Возвращает данные указанной оценки сотрудника.<br/>Объект типа «EmployeeRemark».<br/><br/>
### Поля
...
### Описание метода
Возвращает список оценок сотрудника.<br/>Массив объектов типа «EmployeeRemark».<br/><br/><br/>
### Поля
...
### Описание метода
Изменяет данные оценки оператора.<br/>Метод ничего не возвращает.<br/><br/>
### Поля
...
### Описание метода
Удаляет указанную оценку сотрудника.<br/>Метод ничего не возвращает.<br/><br/>
### Поля
